...
def create_map(filename, fwhm, head = None, smooth = False, planets=False, saveOutput = True, outputName=False, submean=True, ctrlrad=30, method = 'all', checkmask=False, makenoisemap=False, sigma = 5, verbose = False):
    """
